...
Xếp hạng cập nhật từ Final Evaluation (so sánh tất cả phương pháp). Xem Mục 10 trong báo cáo từng dataset để xem chi tiết so sánh các phương pháp.

| Dataset | Phương pháp + Mô hình tốt nhất | Accuracy | Std | Số đặc trưng | Thời gian fit (ms) | Phương pháp thứ 2 + Mô hình | Acc thứ 2 | Phương pháp thứ 3 + Mô hình | Acc thứ 3 |
| --- | --- | ---: | ---: | ---: | ---: | --- | ---: | --- | ---: |
