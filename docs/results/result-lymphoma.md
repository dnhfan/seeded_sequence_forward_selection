...
- Notebook entry point(s):
- `notebook/Lymphoma/10_final_evaluate.ipynb`
- Report artifact: `results/Lymphoma/evaluation/reports/final_evaluation_all_methods_lymphoma_Lymphoma.txt`

[Insert Chart: Final Evaluation - All Methods]
![Lymphoma Final Evaluation](../../results/Lymphoma/evaluation/plots/final_evaluation_all_methods_lymphoma_Lymphoma.png)
